...
# 仓库信息
REPO_URL="https://github.com/vonssy/DePINed-BOT.git"
REPO_DIR="DePINed-BOT"
TMUX_SESSION="depined"
...
# 交互式输入账号和密码
echo "请输入账号和密码（格式：账号,密码 或 账号<tab>密码），每行一个，输入完成后按回车结束："
while true; do
